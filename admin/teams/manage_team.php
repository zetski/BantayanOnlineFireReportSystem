				...
				<div class="container-fluid">
					<form action="" id="team-form">
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" name="leader_contact" id="leader_contact" class="form-control form-control-sm rounded-0" value="<?php echo isset($leader_contact) ? $leader_contact : ''; ?>"  required/>
						</div>
