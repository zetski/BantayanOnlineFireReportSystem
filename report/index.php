                ...
                <div class="card card-outline rounded-0">
                    <div class="card-body">
                        <div class="container-fluid">
                            ...
                            <?php endif;?>
                            <form action="" id="request-form" enctype="multipart/form-data" onsubmit="return validateFullname()">
...
<script>
    ...
    function validateFullname() {
        ...
        // Check each part for a capital first letter
        for (let i = 0; i < nameParts.length; i++) {
            const part = nameParts[i];
            if (part.charAt(0) !== part.charAt(0).toUpperCase() || part.slice(1) !== part.slice(1).toLowerCase()) {
                alert('Each part of your name must start with a capital letter and followed by lowercase letters.');
                return false;
            }
        }
